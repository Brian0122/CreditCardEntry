...
class CardRegex {
    ...
    static final String REGX_JCB = "^(?:2131|1800|35\\d{3})\\d{11})$";
    ...
    static final String REGX_JCB_TYPE = "^(?:2131|1800|35[0-9]{2})";
}
...
public enum CardType implements Serializable {
    ...
    JCB("JCB", R.drawable.jcb, CardRegex.REGX_JCB, CardRegex.REGX_JCB_TYPE);
